...
fun todoTask12(): Nothing = TODO(
    """
        Task 12.
        Kotlin standard library contains lots of extension
        functions that make the work with collections more convenient.
        ...
        Thus in Kotlin we don't introduce our own
        collections, but use standard Java ones (slightly improved).
